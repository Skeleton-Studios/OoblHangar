...
public:
    ...
    UFUNCTION(BlueprintPure)
    static bool LobbyIsPartyEffect(const FName& emoteId);
    ...
    UFUNCTION(BlueprintPure)
    static bool LobbyIsOnlineAgingTestEnable();
    ...
    UFUNCTION(BlueprintPure)
    static bool LobbyGetCrossplayPrivilegeFlag();
    
    UFUNCTION(BlueprintPure)
    static bool LobbyGetCrossplayLobbyFlag();
    
    UFUNCTION(BlueprintPure)
    static bool LobbyGetCrossplayFlagWithoutPrivilegeFlag();
    ...
    UFUNCTION(BlueprintCallable)
    static void LobbyExitGameProcess();
