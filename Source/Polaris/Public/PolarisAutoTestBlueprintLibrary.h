...
public:
    ...
    static bool AutoTest_ReadyNextYBBattle();
    ...
    UFUNCTION(BlueprintPure)
    static bool AutoTest_IsFinishYBBattle();
    ...
    UFUNCTION(BlueprintPure)
    static bool AutoTest_IsFinishAllYBBattle();
    ...
    UFUNCTION(BlueprintCallable)
    static void AutoTest_FinishYBBattleTest();
