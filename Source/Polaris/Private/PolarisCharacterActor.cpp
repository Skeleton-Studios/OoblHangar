...
void APolarisCharacterActor::SetForceVisibleMntParts(bool IsVisible) {
}
...
void APolarisCharacterActor::SetBustDynamicBoneGoalStrength(float GoalStrength) {
}

void APolarisCharacterActor::SetBodyTransform(EPolarisBodyTransformState State, bool isForce, bool IsAlways) {
}

void APolarisCharacterActor::SetAttachmentCollisionForPos(FItemPositionWrapPinStruct _ItemPos, int32 _AccNum, int32 _DepNum, UCatwalkClothCollisionAsset* _InAttachmentCollision, USkinnedMeshComponent* _InAttachedPoseComponent) {
}
...
void APolarisCharacterActor::OnZoneBegin_Implementation(FEventOnZoneBeginParam Param) {
}
...
void APolarisCharacterActor::OnFloorBreakStageRangeItemReset_Implementation(FEventOnFloorBreakStageRangeItemResetParam Param) {
}
...
int32 APolarisCharacterActor::GetPetAnimationNo(int32 anim_no) {
    return 0;
}

int32 APolarisCharacterActor::GetPetAnimationKinds(int32 anim_no) {
    return 0;
}
...
bool APolarisCharacterActor::GetMirror() const {
    return false;
}
...
void APolarisCharacterActor::CalculateOffsetProcessForBP_ReOffset(UItemPrefab* source_ip, FTransform& outTransform, FName& outBoneName) const {
}
