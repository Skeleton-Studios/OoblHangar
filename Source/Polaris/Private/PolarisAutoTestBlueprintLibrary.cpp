...
bool UPolarisAutoTestBlueprintLibrary::AutoTest_ReadyNextYBBattle() {
    return false;
}
...
bool UPolarisAutoTestBlueprintLibrary::AutoTest_IsFinishYBBattle() {
    return false;
}
...
bool UPolarisAutoTestBlueprintLibrary::AutoTest_IsFinishAllYBBattle() {
    return false;
}
...
void UPolarisAutoTestBlueprintLibrary::AutoTest_FinishYBBattleTest() {
}
